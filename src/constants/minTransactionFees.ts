...
export const minTransactionFees: TransactionFeesBigInt = {
  base: AttoXL1(1n), // AttoXL1(1000n * AttoXL1ConvertFactor.micro),
  gasPrice: AttoXL1(0n), // AttoXL1(10n * AttoXL1ConvertFactor.micro),
  gasLimit: AttoXL1(0n), // AttoXL1(1_000_000n * AttoXL1ConvertFactor.micro),
